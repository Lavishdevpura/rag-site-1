...
#
# This list is ALSO read by the hollow-answer detector's _has_domain_word
# check further down this file — see that check's own comment for why it
# treats an empty list as "skip this check" rather than "no domain word
# found" (2026-08-18 fix, found live: the naive version silently disabled
# the safety guard whenever this list was empty, misfiring on any short-
# but-genuine answer regardless of topic).
_INSURANCE_VOCAB = []
